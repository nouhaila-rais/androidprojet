...
import fr.uge.projetandroid.adapters.Adapter_SlideAccueil_Emprunt;
import fr.uge.projetandroid.entities.User;

public class Accueil_Emprunt extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private ViewPager viewpager_home_emprunt;
    private LinearLayout LinearLayout_home_dots_emprunt;
    private Adapter_SlideAccueil_Emprunt adapterSlideAccueilEmprunt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterSlideAccueilEmprunt =new Adapter_SlideAccueil_Emprunt(this,user);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if(query!=null){
                    Intent myIntent = new Intent(Accueil_Emprunt.this, Afficher_ProduitsRecherche_Emprunt.class);
